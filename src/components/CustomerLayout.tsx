...
const CustomerLayout: React.FC<CustomerLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/customer/dashboard', icon: <Home className="w-5 h-5" /> },
    { name: 'Orders', path: '/customer/orders', icon: <Package className="w-5 h-5" /> },
    { name: 'History', path: '/customer/history', icon: <History className="w-5 h-5" /> },
  ];
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex flex-col items-center p-4 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="mt-2 text-center">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">{user?.name || 'Customer'}</p>
